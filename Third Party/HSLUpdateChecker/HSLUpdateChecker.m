...
+ (void)checkForUpdate
{
    [[NSUserDefaults standardUserDefaults] setBool:NO forKey:@"appUpdateAvailable"];
            ...
            else
            {
                ...
                if (results.count > 0)
                {
                    ...
                    if (localVersion && ![localVersion isEqualToString:appStoreVersion])
                    {
                        ...
                        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"appUpdateAvailable"];
                        [[NSUserDefaults standardUserDefaults] setValue:result[@"trackViewUrl"] forKey:@"appUpdateUrl"];
                        [[NSUserDefaults standardUserDefaults] setValue:result[@"releaseNotes"] forKey:@"appUpdateDescription"];
                        [[NSUserDefaults standardUserDefaults] synchronize];
                    }
                }
            }
